...
function insertIntoArrayTable8() {
    ...
    ExecutionResult | error result = executeQueryMockClient1(sqlQuery);
    ...
    result = executeQueryMockClient1(sqlQuery);
...
function executeQueryMockClient1(ParameterizedQuery sqlQuery)
